# Generated by Powerlevel10k configuration wizard on 2026-02-04 at 14:20 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    battery                 # internal battery (shown only when low)
    # wifi                  # wifi speed
  ...
  # Hide battery segment when charging, charged, or discharging above threshold (show only when low).
  typeset -g POWERLEVEL9K_BATTERY_{CHARGING,CHARGED,DISCONNECTED}_CONTENT_EXPANSION=
  typeset -g POWERLEVEL9K_BATTERY_{CHARGING,CHARGED,DISCONNECTED}_VISUAL_IDENTIFIER_EXPANSION=
