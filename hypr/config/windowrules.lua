...
-- Nautilus: keep icons/text solid; gtk-4.0/nautilus.css makes the background translucent for blur
hl.window_rule({ match = { class = "^(org\\.gnome\\.Nautilus|Nautilus)$" }, opacity = "1.0 override" })
