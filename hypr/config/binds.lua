...
for i = 1, NUM_WPM do
    ...
    -- Move window to relative workspace on monitor
    hl.bind(mainMod .. " + ALT + SHIFT + " .. key, hl.dsp.window.move({ workspace = "m~" .. i }))
end
...
hl.bind("F12",                 hl.dsp.exec_cmd(noctCall .. "screenshot-region"))
hl.bind(mainMod .. " + F12",   hl.dsp.exec_cmd(noctCall .. "screenshot-fullscreen"))
