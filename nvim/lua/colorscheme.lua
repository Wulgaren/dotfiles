...
local function apply_overrides()
	...
	local groups = {
		...
		Pmenu = { fg = frappe.text, bg = "NONE" },
		PmenuSel = { fg = frappe.lavender, bg = "#3b3f52", bold = true },
		PmenuSbar = { bg = "NONE" },
		PmenuThumb = { bg = frappe.overlay0 },
		PmenuMatch = { fg = frappe.text, bold = true },
		PmenuExtra = { fg = frappe.subtext1, bg = "NONE" },
		PmenuExtraSel = { fg = frappe.subtext1, bg = "#3b3f52", bold = true },
	}
